...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\SlaughterHeadMeatMidriff>
 */
class SlaughterHeadMeatMidriffFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'e_coli' => fake()->randomFloat(1, 0, 3),
            'staphylococcus' => fake()->randomFloat(1, 0, 3),
        ];
    }
}
