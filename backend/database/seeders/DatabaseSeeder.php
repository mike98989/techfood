...
"daily_hygiene_rounds": "Dagliga hygienrundor","settings": "Inställningar","menu": "MENY","home": "Hem","date": "Datum","month": "Månad","section": "Avdelning","cause": "Orsaka","status": "Status","deviation_type": "Typ av avvikelse","batch_number": "Satsnummer","protein_value": "Proteinvärde","lactose_value": "Laktosvärde","water_value": "Vattenvärde","actions": "Handlingar","from":"Från","to":"Till","heading_protein_lactose_water": "Digitalisering och uppföljning av protein- och vatteninnehållsanalysresultat från produktionen","heading_fruit_production": "Digitalisering av livsmedelssäkerhet uppföljning","heading_deviation_complaints": "Digitalisering och uppföljning av Avvikelse uppföljning","english": "Engelska","swedish": "Svenska","french": "Franska","spanish": "Spanska","portuguese": "Portugisiska","fruit_production_fruit_key": {"orange":"Orange","apple":"Äpple","banana":"Banan","strawberry":"Jordgubb","cherries":"Körsbär","avocado":" Avocado","watermelon":"Vattenmelon","grape":"Druva"},"chart_type": "Diagramtyp",
  ...
  "yes": "Ja",
  "no": "Nej",
"fruit_production_cause_key": {"tidiness_and_cleaning":"Städning och städning","maintenance":"Underhåll","order_and_order":"Ordning och ordning","pest":"Pest","food_hygiene":"Livsmedelshygien"},
...
"deviation_complaint_deviation_types_key": {
  ...
  "deviation_complaint_remark_key":{
    ...
    "ccp-sight": "CCP - Sikt",
    "ccp-metal_detector": "CCP - Metalldetektor",
    "cip_disk": "CIP-skiva",
    ...
    "damaged_use_glass_in_product": "Skadad användning, glas i produkten",
    "undamaged_use_glass_in_product": "Oskadad användning, glas i produkten",
...
"fruit_production_cause_key": {"tidiness_and_cleaning":"Rangement et nettoyage","maintenance":"Maintenance","order_and_order":"Ordre et ordre","pest":"Parasite","food_hygiene":"Hygiène alimentaire"},
...
"deviation_complaint_deviation_types_key": {
  ...
  "deviation_complaint_remark_key": {
    ...
    "ccp-sight": "CCP - Vue",
    "ccp-metal_detector": "CCP - Détecteur de métaux",
    "cip_disk": "Disque CIP",
    ...
    "damaged_use_no_glass_in_product": "Utilisation endommagée, sans verre dans le produit",
    "damaged_use_glass_in_product": "Utilisation endommagée, verre dans le produit",
    "undamaged_use_glass_in_product": "Utilisation intacte, verre dans le produit",
  ...
  "ccp_follow_up": "Acompanhamento CCP",
...
"deviation_complaint_remark_key": {
    ...
    "ccp-sight": "CCP - Visão",
    "ccp-metal_detector": "CCP - Detector de metais",
    "cip_disk": "Disco CIP",
    ...
    "damaged_use_no_glass_in_product": "Uso danificado, sem vidro no produto",
    "damaged_use_glass_in_product": "Uso danificado, vidro no produto",
    "undamaged_use_glass_in_product": "Uso intocado, vidro no produto",
...
"deviation_complaint_section_key": {"lab": "LAB", "the_warehouse": "El almacén", "dry_side": "Lado seco", "wet_side": "Lado húmedo", "workshop": "Taller", "out": "Fuera", "miscellaneous": "Misceláneo"},"deviation_complaint_deviation_types_key": {
  ...
  "deviation_complaint_remark_key": {
    ...
    "ccp-sight": "CCP - Vista",
    "ccp-metal_detector": "CCP - Detector de metales",
    "cip_disk": "Disco CIP",
    ...
    "hair": "Cabello",
    "difficult_to_prepare": "Difícil de preparar",
    "damaged_use_no_glass_in_product": "Uso dañado, sin vidrio en el producto",
    "damaged_use_glass_in_product": "Uso dañado, vidrio en el producto",
    "undamaged_use_glass_in_product": "Uso no dañado, vidrio en el producto",
