...
const EditDrillSample = (props: any) => {
        ...
        <div className="w-full">
          ...
          <form
            onSubmit={(e) => {
              ...
              setIsLoading(true);
              fetchApi({
                url: "drillsamples/" + value.id, // End Point
                method: "PUT", // Method
                formData: formData,
                contentType: "application/json", //Content Type
                authentication: user.token,
...
export default EditDrillSample;
