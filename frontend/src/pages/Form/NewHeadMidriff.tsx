...
import { DynamicInputFieldsHeadMidRiff } from "../../methods/DynamicInputFields"; // Import the hook
              ...
              <div>
                ...
                <ul className="mt-1.5 list-none list-inside">
                  <li className="flex flex-row">
                    ...
                    {computeValues.countEcoliValid
                      ? Math.round(
                          ((computeValues.countEcoliValid * 1) /
                            computeValues.totalEcoliCount) *
                            1 *
                            100
                        )
                      : 0}
                  ...
                  <li className="flex flex-row">
                    ...
                    {computeValues.countEcoliInvalid
                      ? Math.round(
                          ((computeValues.countEcoliInvalid * 1) /
                            computeValues.totalEcoliCount) *
                            1 *
                            100
                        )
                  ...
                  <li className="font-bold">
                    Total = {computeValues.totalEcoliCount}
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div>
                ...
                <ul className="mt-1.5 list-none list-inside">
                  <li className="flex flex-row">
                    ...
                    {computeValues.countStaphylococcusValid
                      ? Math.round(
                          ((computeValues.countStaphylococcusValid * 1) /
                            computeValues.totalStaphylococcusCount) *
                            1 *
                            100
                        )
                      : 0}
                  ...
                  <li className="flex flex-row">
                    ...
                    {computeValues.countStaphylococcusInvalid
                      ? Math.round(
                          ((computeValues.countStaphylococcusInvalid * 1) /
                            computeValues.totalStaphylococcusCount) *
                            1 *
                            100
                        )
                  ...
                  <li className="font-bold">
                    Total = {computeValues.totalStaphylococcusCount}
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="">
            ...
            <form
              onSubmit={(e) => {
                formSubmit({
                  event: e,
                  action_url: "headmidriffs",
                  method: "POST",
                  formId: "",
                  formData: headMidRiffs,
            ...
            >
              {headMidRiffs.map((headmidriff, index) => (
                <div key={index}>
                  ...
                  <div className="flex md:flex-row md:flex-wrap p-2">
                    ...
                    <div className="flex-1 md:w-1/2 md:mb-0 mr-1">
                      ...
                      <input
                        type="date"
                        name="slaughter_date[]"
                        value={headmidriff.slaughter_date}
                  ...
                  <div className="flex md:flex-row md:flex-wrap p-2">
                    ...
                    <div className="flex-1 md:w-1/2 md:mb-0">
                      ...
                      <input
                        ...
                        id="small-input"
                        name="staphylococcus[]"
                        value={headmidriff.staphylococcus}
                        onBlur={() => handleCompute()}
                        onChange={(e) =>
                          handleInputChange({
                            index,
