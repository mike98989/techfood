...
const formatDataForChart = (
  ...
  const data = dataArray.sort(
    (a: any, b: any) =>
      new Date(a.occurance_date).getTime() -
      new Date(b.occurance_date).getTime()
  );
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    deviationTypes[data[i]?.deviation_type?.name_key] ||= {};
    deviationTypes[data[i]?.deviation_type?.name_key][yearMonth] ||= 0;
    deviationTypes[data[i]?.deviation_type?.name_key][yearMonth]++;
...
const HygieneRoundsChart1: React.FC<ChartProps> = (props: any) => {
        ...
        <div className="-ml-5 md:w-full">
          <div className="flex w-full text-center justify-center content-center self-center items-center my-3">
            ...
            <p className=" text-cyan-900 dark:text-white font-thin">
              {t("daily_hygiene_rounds") + " - " + t("risk_category")}
            </p>
          </div>
      ...
      <div className="md:flex mt-4 md:flex-row w-full">
        <div className="-ml-5 md:w-full">
          <div className="flex w-full text-center justify-center content-center self-center items-center my-3">
            ...
            <p className=" text-cyan-900 dark:text-white font-thin">
              {t("daily_hygiene_rounds") + " - " + t("deviation_type")}
            </p>
          </div>
      ...
      <div className="md:flex mt-4 md:flex-row w-full">
        <div className="-ml-5 md:w-full">
          <div className="flex w-full text-center justify-center content-center self-center items-center my-3">
            ...
            <p className=" text-cyan-900 dark:text-white font-thin">
              {t("daily_hygiene_rounds") + " - " + t("product")}
            </p>
          </div>
...
export default HygieneRoundsChart1;
