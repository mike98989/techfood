...
const ProductivityFollowup = () => {
  const [ProductivityFollowUps, setProductivityFollowUps] = useState([]);
  ...
  useEffect(() => {
    ...
    allRequest({
      event: null,
      action_url:
        `productivityfollowups?paginate=` +
        PAGINATE_ITEM_COUNT +
      ...
      setIsLoading,
      setReturnData: setProductivityFollowUps,
    });
  }, [currentPage]);
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        {!isLoading && (
          <div className="px-4 py-4">
            <PaginateSpanHeader
              totalPageItemCount={ProductivityFollowUps.to}
              TotalItemCount={ProductivityFollowUps.total}
            />
          </div>
        )}
        <div className="max-w-full overflow-x-auto">
          <table className="w-full table-auto">
            ...
            <tbody>
              {ProductivityFollowUps?.data?.length > 0 &&
                ProductivityFollowUps?.data.map((input: any, key) => (
                  <tr
                    key={key}
                  ...
                  >
                    <td className="text-sm border-b border-[#eee] py-3 px-2 pl-1 dark:border-strokedark xl:pl-3">
                      {ProductivityFollowUps.from + key}
                    </td>
                            ...
                            setOpenModal(true),
                              setModalQueryData({
                                ...
                                modalData: {
                                  ...
                                  data: ProductivityFollowUps,
                                  setData: setProductivityFollowUps,
                                },
                              });
                          }}
                        >
              ...
              {!isLoading && ProductivityFollowUps?.data?.length == 0 && (
                <tr>
                  <td
          ...
          <div className="pl-3 pt-2">
            ...
            <Spinner />
            <Paginate
              currentPage={ProductivityFollowUps.current_page}
              totalPages={ProductivityFollowUps.last_page}
